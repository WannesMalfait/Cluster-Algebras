...
the existence of a matrix is already assumed. With the preparatory work that we have
...
\begin{proposition}\label{prop:inductive_mutation}
	...
	\end{equation*}
	%
	for all $l\in \ex$. Then, its principal part is skew-symmetrizable and the columns
...
\begin{proof}[Proof of \cref{thm:gy_main_result} (a), (b) and (c)]
	...
	\cref{prop:inductive_mutation} for $\tau_{l-1}$ and $\tau_{l}$. In this case
	...
	\cref{prop:inductive_mutation} where we swap the roles of $\tau$ and $\tau'$ if
